...
@Autonomous(name= "RedStoneOnFound", group="red")
//@Disabled//comment out this line before using
public class RedStoneOnFoundation extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (valLeft == 0) { // skystone is in position 1 and 4
            ...
            robot.sideGrabber.moveLeftGrabber("upEmpty", "open");
            sleep(400);
            robot.sideGrabber.moveLeftGrabber("down", "open");
            sleep(400);
            robot.sideGrabber.moveLeftGrabber("down", "closed");
            sleep(400);
            robot.sideGrabber.moveLeftGrabber("upBlock", "closed");
            sleep(500);
            ...
            robot.sideGrabber.moveLeftGrabber("upEmpty", "closed");
